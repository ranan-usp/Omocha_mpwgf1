...
N 1170 -300 1200 -300 {lab=vss}
N 1200 -320 1200 -300 {lab=vss}
N 1170 -440 1200 -440 {lab=vdd}
N 1200 -440 1200 -420 {lab=vdd}
...
N 520 -410 520 -380 {lab=vss}
N 520 -90 520 -60 {lab=vss}
N 520 -640 520 -610 {lab=vdd}
...
N 520 -330 520 -290 {lab=vdd}
N 1320 -640 1320 -610 {lab=vdd}
N 1320 -550 1320 -520 {lab=vss}
...
N 1500 -80 1530 -80 {lab=vdd}
N 1500 -60 1530 -60 {lab=vss}
N 1000 -320 1000 -290 { lab=clkca}
N 1060 -220 1060 -190 {lab=vdd}
N 970 -300 970 -270 { lab=vss}
...
C {devices/lab_wire.sym} 970 -440 3 1 {name=l66 sig_type=std_logic lab=vdd}
C {sar_10b/latch/latch.sym} 1200 -370 0 0 {name=xlat}
C {devices/noconn.sym} 1315 -350 2 0 {name=l87}
C {devices/lab_wire.sym} 1200 -300 0 0 {name=l5 sig_type=std_logic lab=vss
}
C {devices/lab_wire.sym} 1200 -440 0 0 {name=l6 sig_type=std_logic lab=vdd
}
C {devices/iopin.sym} 70 -510 0 0 {name=p6 lab=vss}
C {devices/iopin.sym} 70 -540 0 0 {name=p8 lab=vdd}
...
C {devices/lab_wire.sym} 520 -290 1 0 {name=l24 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 520 -410 3 0 {name=l15 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 520 -90 3 0 {name=l25 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 520 -610 1 0 {name=l14 sig_type=std_logic lab=vdd}
C {devices/opin.sym} 70 -220 2 1 {name=p14 lab=valid}
C {devices/ipin.sym} 70 -290 0 1 {name=p15 lab=cal}
C {devices/lab_wire.sym} 970 -300 3 0 {name=l2 sig_type=std_logic lab=vss}
...
C {devices/lab_wire.sym} 1320 -610 1 0 {name=l18 sig_type=std_logic lab=vdd
}
C {devices/lab_wire.sym} 1320 -550 1 1 {name=l26 sig_type=std_logic lab=vss
}
...
C {devices/lab_wire.sym} 1500 -80 0 1 {name=l7 sig_type=std_logic lab=vdd
}
C {devices/lab_wire.sym} 1500 -60 0 1 {name=l8 sig_type=std_logic lab=vss
}
C {sar_10b/control/sarlogic.sym} 1200 -40 0 0 {name=xlogic
}
C {devices/lab_wire.sym} 1060 -190 3 1 {name=l10 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 1060 -150 3 0 {name=l12 sig_type=std_logic lab=vss}
C {logic/buffer_lvt.sym} 950 -150 0 1 {name=xbuf
}
C {devices/lab_wire.sym} 1000 -220 1 0 {name=l20 sig_type=std_logic lab=clkca
}
C {symbols/cap_mim_2p0fF.sym} 1320 -580 0 0 {name=C1
W=1e-6
L=1e-6
model=cap_mim_2f0fF
spiceprefix=X
